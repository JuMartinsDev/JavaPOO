...
public class JogoGui {
	...
	public static void main(String[] args) {
		...
		if(f.acertou()) {
			JOptionPane.showMessageDialog(null, "Parabéns, a palavra era "+f.getPalavraAberta());
		}else {
			JOptionPane.showMessageDialog(null, "Errou, a palavra era "+f.getPalavraFechada());
		}
